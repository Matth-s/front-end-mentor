...
const Feedback = () => {
  ...
  useEffect(() => {
    const idUrl = location.pathname.replace("feedback", "").replaceAll("/", "");
  ...
  }, [dispatch, location.pathname, selectorViewFeedback.length, navigate]);
          ...
          <div className="commentary-div border-radius">
            ...
            {feedback.comments.length > 0 &&
              feedback.comments.map((comment) => (
                <div key={comment.id} className="regroupComment">
